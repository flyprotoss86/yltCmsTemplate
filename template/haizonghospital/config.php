<?php return array (
  'name' => '海军总医院',
  'author' => 'PHPCMS TEAM',
  'dirname' => 'haizonghospital',
  'homepage' => 'http://www.phpcms.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|haizonghospital|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|haizonghospital|vote' => 
    array (
      'index.html' => '',
      'list_new.html' => '列表页',
      'show.html' => '展示页',
    ...
    'templates|haizonghospital|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|haizonghospital|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|haizonghospital|poster' => 
    array (
      'banner.html' => '矩形横幅',
      'couplet.html' => '对联广告',
      'fixure.html' => '固定位置',
    ...
    'templates|haizonghospital|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|haizonghospital|wap' => 
    array (
    ...
    'templates|haizonghospital|message' => 
    array (
      'group.html' => '系统消息',
      'inbox.html' => '收件箱',
      'outbox.html' => '发件箱',
    ...
    'templates|haizonghospital|member' => 
    array (
    ...
    'templates|haizonghospital|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|haizonghospital|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|haizonghospital|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|haizonghospital|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|haizonghospital|yp' => 
    array (
      'com_haizonghospital' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|haizonghospital|yp|com_haizonghospital' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|haizonghospital|comment' => 
    array (
