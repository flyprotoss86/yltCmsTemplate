<?php return array (
  'name' => '航天医院',
  'author' => '医汇联',
  'dirname' => 'hangtianhospital',
  'homepage' => 'http://www.phpcms.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|hangtianhospital|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|hangtianhospital|vote' => 
    array (
      'index.html' => '',
      'list_new.html' => '列表页',
      'show.html' => '展示页',
    ...
    'templates|hangtianhospital|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|hangtianhospital|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|hangtianhospital|poster' => 
    array (
      'banner.html' => '矩形横幅',
      'couplet.html' => '对联广告',
      'fixure.html' => '固定位置',
    ...
    'templates|hangtianhospital|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|hangtianhospital|wap' => 
    array (
    ...
    'templates|hangtianhospital|pay' => 
    array (
      'deposit.html' => '支付页模板',
    ...
    'templates|hangtianhospital|message' => 
    array (
      'group.html' => '系统消息',
      'inbox.html' => '收件箱',
      'outbox.html' => '发件箱',
    ...
    'templates|hangtianhospital|member' => 
    array (
    ...
    'templates|hangtianhospital|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|hangtianhospital|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|hangtianhospital|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|hangtianhospital|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|hangtianhospital|yp' => 
    array (
      'com_hangtianhospital' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|hangtianhospital|yp|com_hangtianhospital' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|hangtianhospital|comment' => 
    array (
