<?php return array (
  'name' => '玉泉医院',
  'author' => 'PHPCMS TEAM',
  'dirname' => 'yuquanhospital',
  'homepage' => 'http://www.phpcms.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|yuquanhospital|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|yuquanhospital|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|yuquanhospital|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|yuquanhospital|poster' => 
    array (
      'banner.html' => '矩形横幅',
      'couplet.html' => '对联广告',
      'fixure.html' => '固定位置',
    ...
    'templates|yuquanhospital|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|yuquanhospital|wap' => 
    array (
    ...
    'templates|yuquanhospital|message' => 
    array (
      'group.html' => '系统消息',
      'inbox.html' => '收件箱',
      'outbox.html' => '发件箱',
    ...
    'templates|yuquanhospital|member' => 
    array (
    ...
    'templates|yuquanhospital|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|yuquanhospital|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|yuquanhospital|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|yuquanhospital|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|yuquanhospital|yp' => 
    array (
      'com_yuquanhospital' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|yuquanhospital|yp|com_yuquanhospital' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|yuquanhospital|comment' => 
    array (
