<?php return array (
  'name' => '华信医院模板',
  'author' => 'PHPCMS TEAM',
  'dirname' => 'huaxinHospital',
  'homepage' => 'http://www.phpcms.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|huaxinHospital|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|huaxinHospital|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|huaxinHospital|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|huaxinHospital|poster' => 
    array (
      'banner.html' => '矩形横幅',
      'couplet.html' => '对联广告',
      'fixure.html' => '固定位置',
    ...
    'templates|huaxinHospital|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|huaxinHospital|wap' => 
    array (
    ...
    'templates|huaxinHospital|message' => 
    array (
      'group.html' => '系统消息',
      'inbox.html' => '收件箱',
      'outbox.html' => '发件箱',
    ...
    'templates|huaxinHospital|member' => 
    array (
    ...
    'templates|huaxinHospital|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|huaxinHospital|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|huaxinHospital|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|huaxinHospital|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|huaxinHospital|yp' => 
    array (
      'com_huaxinHospital' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|huaxinHospital|yp|com_huaxinHospital' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|huaxinHospital|comment' => 
    array (
