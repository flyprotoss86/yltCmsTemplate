<?php return array (
  'name' => '武警总医院',
  'author' => '医汇联',
  'dirname' => 'wujinghospital',
  'homepage' => 'http://www.phpcms.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|wujinghospital|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|wujinghospital|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|wujinghospital|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|wujinghospital|poster' => 
    array (
      'banner.html' => '矩形横幅',
      'couplet.html' => '对联广告',
      'fixure.html' => '固定位置',
    ...
    'templates|wujinghospital|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|wujinghospital|wap' => 
    array (
    ...
    'templates|wujinghospital|message' => 
    array (
      'group.html' => '系统消息',
      'inbox.html' => '收件箱',
      'outbox.html' => '发件箱',
    ...
    'templates|wujinghospital|member' => 
    array (
    ...
    'templates|wujinghospital|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|wujinghospital|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|wujinghospital|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|wujinghospital|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|wujinghospital|yp' => 
    array (
      'com_wujinghospital' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|wujinghospital|yp|com_wujinghospital' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|wujinghospital|comment' => 
    array (
