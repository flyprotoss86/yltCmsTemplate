<?php return array (
  'name' => '东方医院',
  'author' => 'PHPCMS TEAM',
  'dirname' => 'dongfang_hospital',
  'homepage' => '',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|dongfang_hospital|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|dongfang_hospital|vote' => 
    array (
      'index.html' => '',
      'list_new.html' => '列表页',
      'show.html' => '展示页',
    ...
    'templates|dongfang_hospital|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|dongfang_hospital|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|dongfang_hospital|poster' => 
    array (
      'banner.html' => '矩形横幅',
      'couplet.html' => '对联广告',
      'fixure.html' => '固定位置',
    ...
    'templates|dongfang_hospital|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|dongfang_hospital|wap' => 
    array (
    ...
    'templates|dongfang_hospital|pay' => 
    array (
      'deposit.html' => '支付页模板',
    ...
    'templates|dongfang_hospital|message' => 
    array (
      'group.html' => '系统消息',
      'inbox.html' => '收件箱',
      'outbox.html' => '发件箱',
    ...
    'templates|dongfang_hospital|member' => 
    array (
    ...
    'templates|dongfang_hospital|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|dongfang_hospital|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|dongfang_hospital|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|dongfang_hospital|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|dongfang_hospital|yp' => 
    array (
      'com_dongfang_hospital' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|dongfang_hospital|yp|com_dongfang_hospital' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|dongfang_hospital|comment' => 
    array (
