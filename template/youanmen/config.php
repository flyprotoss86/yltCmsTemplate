<?php return array (
  ...
  array (
    ...
    'templates|youanmen|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|youanmen|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|youanmen|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|youanmen|wap' => 
    array (
    ...
    'templates|youanmen|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|youanmen|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|youanmen|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|youanmen|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|youanmen|yp' => 
    array (
      'com_youanmen' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|youanmen|yp|com_youanmen' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|youanmen|comment' => 
    array (
