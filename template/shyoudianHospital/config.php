<?php return array (
  'name' => '上海邮电模板',
  'author' => 'PHPCMS TEAM',
  'dirname' => 'shyoudianHospital',
  'homepage' => 'http://www.phpcms.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|shyoudianHospital|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|shyoudianHospital|vote' => 
    array (
      'index.html' => '',
      'list_new.html' => '列表页',
      'show.html' => '展示页',
    ...
    'templates|shyoudianHospital|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|shyoudianHospital|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|shyoudianHospital|poster' => 
    array (
      'banner.html' => '矩形横幅',
      'couplet.html' => '对联广告',
      'fixure.html' => '固定位置',
    ...
    'templates|shyoudianHospital|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|shyoudianHospital|wap' => 
    array (
    ...
    'templates|shyoudianHospital|pay' => 
    array (
      'deposit.html' => '支付页模板',
    ...
    'templates|shyoudianHospital|message' => 
    array (
      'group.html' => '系统消息',
      'inbox.html' => '收件箱',
      'outbox.html' => '发件箱',
    ...
    'templates|shyoudianHospital|member' => 
    array (
    ...
    'templates|shyoudianHospital|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|shyoudianHospital|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|shyoudianHospital|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|shyoudianHospital|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|shyoudianHospital|yp' => 
    array (
      'com_shyoudianHospital' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|shyoudianHospital|yp|com_shyoudianHospital' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|shyoudianHospital|comment' => 
    array (
